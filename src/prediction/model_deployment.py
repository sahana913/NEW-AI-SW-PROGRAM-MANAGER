...
class ModelDeployment:
    ...
    def create_model(
        ...
        try:
            self.sagemaker_client.create_model(
                ...
                PrimaryContainer={"Image": container_image, "ModelDataUrl": model_data},
    ...
    def create_endpoint(
        self, config_name: str, endpoint_name: Optional[str] = None
    ) -> str:
        """
    ...
    def configure_autoscaling(
        ...
        try:
            ...
            logger.info(
                f"Auto-scaling configured: min={min_capacity}, max={max_capacity}"
            )
    ...
    def deploy_model(
        ...
        if enable_autoscaling:
            self.configure_autoscaling(
                endpoint_name, min_capacity=min_capacity, max_capacity=max_capacity
            )
