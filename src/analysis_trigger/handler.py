    ...
    try:
        ...
        for project_info in stored_projects:
            ...
            try:
                ...
                error_msg = f"Failed to trigger analysis for project {project_id}: {str(e)}"
        ...
        logger.info(f"Analysis trigger completed successfully for {len(triggered_jobs)} projects")
