...
class DeliveryLogger:
    ...
    def log_attempt(
        ...
        try:
            ...
            logger.error(
                ...
                extra={"report_id": report_id, "recipient": recipient, "error": str(e)},
            )
    ...
    def log_failure(
        self, report_id: str, recipient: str, tenant_id: str, attempts: int, error: str
    ) -> str:
        """
    ...
    def log_skipped(
        self, report_id: str, recipient: str, tenant_id: str, reason: str
    ) -> str:
        """
