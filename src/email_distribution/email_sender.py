...
class EmailSender:
    ...
    def send_report_email(
        self, recipient: str, report_details: Dict[str, Any], tenant_id: str
    ) -> str:
        """
        ...
        if report_details.get("s3_key"):
            pdf_attachment = self._get_pdf_from_s3(
                s3_key=report_details["s3_key"], report_type=report_type
            )
            if pdf_attachment:
    ...
    def _generate_subject(
        self, report_type: str, report_details: Dict[str, Any]
    ) -> str:
    ...
    def _generate_text_body(
        self, report_details: Dict[str, Any], tenant_id: str
    ) -> str:
        """
...
"""
    ...
    def _get_pdf_from_s3(
        self, s3_key: str, report_type: str
