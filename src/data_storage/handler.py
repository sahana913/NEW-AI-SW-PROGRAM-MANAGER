    ...
    try:
        ...
        try:
            ...
            return {
                "statusCode": 500,
                "stored": False,
                "errors": [{"error": "Database connection failed", "details": str(e)}],
            }
        ...
        for item in validated_data:
            ...
            try:
                ...
                error_msg = (
                    f"Failed to store project {project_id} from {source}: {str(e)}"
                )
        ...
        if storage_errors:
            ...
            if not stored_projects:
                return {"statusCode": 500, "stored": False, "errors": storage_errors}
        ...
        logger.info(
            f"Storage completed successfully for {len(stored_projects)} projects"
        )

        return {"statusCode": 200, "stored": True, "storedProjects": stored_projects}
        ...
        return {
            "statusCode": 500,
            "stored": False,
            "errors": [{"error": "Internal storage error", "details": str(e)}],
        }
