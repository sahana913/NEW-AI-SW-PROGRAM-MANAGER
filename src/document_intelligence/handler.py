...
from .sow_extraction import extract_milestones_from_sow
from .sla_extraction import extract_sla_clauses_from_contract
from .extraction_confirmation import confirm_extraction, get_extractions_for_document
...
def handle_extract_request(
    ...
    # Use get_item instead of scan for O(1) lookup by PK/SK
