...
def store_project_data(
    tenant_id: str, project_data: Dict[str, Any], source: str = "JIRA"
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.info(
            f"Validating project data for {project_data.get('projectName', 'unknown')}"
        )
        ...
        logger.info(f"Successfully stored project data: {storage_counts}")
...
def store_multiple_projects(
    tenant_id: str, projects: List[Dict[str, Any]], source: str = "JIRA"
) -> Dict[str, Any]:
    """
