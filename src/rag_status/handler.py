...
def calculate_rag_status_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    if not project_id or not tenant_id or health_score is None:
        raise ValidationError("Missing required parameters: project_id, tenant_id, and health_score")
    ...
    try:
        ...
        logger.info(
            ...
            extra={
                ...
                "degradation_detected": detect_status_degradation(current_status, previous_status)
            }
        )
    ...
    try:
        ...
        if not rag_status:
            return {
                ...
                "body": json.dumps({
                    "message": "No RAG status found for project"
                })
            }
...
@with_error_handling
@with_tenant_isolation
def get_rag_status_history_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
